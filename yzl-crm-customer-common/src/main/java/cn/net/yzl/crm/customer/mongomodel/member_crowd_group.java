...
public class member_crowd_group {
    ...
    private List<Integer> member_month;
...
//    private List<String> active_type;
    ...
    public List<String> getMember_grade() {
        return member_grade;
    }

    public void setMember_grade(List<String> member_grade) {
    ...
    public void setActives(List<Integer> actives) {
    ...
    public List<Integer> getMember_month() {
        return member_month;
    }

    public void setMember_month(List<Integer> member_month) {
    ...
    public List<crowd_member_action> getPhone_time() {
        return phone_time;
    }

    public void setPhone_time(List<crowd_member_action> phone_time) {
        this.phone_time = phone_time;
    }

    public List<crowd_member_action> getNature() {
        return nature;
    }

    public void setNature(List<crowd_member_action> nature) {
        this.nature = nature;
    }

    public List<crowd_member_action> getResponse_time() {
        return response_time;
    }

    public void setResponse_time(List<crowd_member_action> response_time) {
        this.response_time = response_time;
    }

    public List<crowd_member_action> getStaff_sex() {
        return staff_sex;
    }

    public void setStaff_sex(List<crowd_member_action> staff_sex) {
        this.staff_sex = staff_sex;
    }

    public List<crowd_member_action> getActions() {
        return actions;
    }

    public void setActions(List<crowd_member_action> actions) {
        this.actions = actions;
    }

    public List<crowd_member_action> getOrder_action() {
        return order_action;
    }

    public void setOrder_action(List<crowd_member_action> order_action) {
        this.order_action = order_action;
    }

    public List<crowd_member_action> getActive_like() {
        return active_like;
    }

    public void setActive_like(List<crowd_member_action> active_like) {
    ...
    public List<Integer> getPay_form() {
        return pay_form;
    }

    public void setPay_form(List<Integer> pay_form) {
    ...
    public List<String> getOrder_state() {
        return order_state;
    }

    public void setOrder_state(List<String> order_state) {
    ...
    public List<Integer> getOrder_source() {
        return order_source;
    }

    public void setOrder_source(List<Integer> order_source) {
