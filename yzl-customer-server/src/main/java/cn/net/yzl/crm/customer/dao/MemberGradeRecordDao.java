...
public interface MemberGradeRecordDao {
    ...
    List<MemberGradeRecordDto> getMemberGradeRecordListByTimeRange(@Param("memberCard")String memberCard, @Param("startTime")String startTime, @Param("endTime")String endTime);
}