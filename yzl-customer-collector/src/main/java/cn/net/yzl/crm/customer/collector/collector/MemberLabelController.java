...
import cn.net.yzl.crm.customer.collector.service.MemberLabelSyncService;
...
public class MemberLabelController {
    ...
    @Autowired
    private MemberLabelSyncService memberLabelSyncService;
...
//    }
    ...
    @GetMapping("/member/syncMemberById")
    public boolean syncMemberById(@RequestParam(defaultValue = "0") int id){
        return memberLabelSyncService.syncMember(id);
    }
}
